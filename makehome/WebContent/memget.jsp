...
String strpnb=request.getParameter("pnb");
out.println("전화번호 :" + strpnb + "<br/>");
String strpln=request.getParameter("pln");
out.println("주소 :" + strpln  );
String strlpn=request.getParameter("lpn");
out.println(  strlpn + "<br/>");
String strgnd=request.getParameter("gnd");
out.println("성별 :" + strgnd + "<br/>");
String strfms=request.getParameter("fms");
out.println("관심 :" + strfms + "<br/>");
String streml=request.getParameter("eml");
out.println("이메일 :" + streml + "<br/>");

%>
<a href='log.html'>로그인하러가기</a> <a href='mem.html'>다시작성하러가기</a>
</div>
		</div>
			<!-- section -->
		<div class='footer'>
